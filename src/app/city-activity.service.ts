...
export class CityActivityService {
  ...
  api_base_uri:string = "https://public.opendatasoft.com/api/records/1.0/search/?dataset=worldcitiespop&rows=10&sort=population&facet=country&refine.country=";

//   countrycodes:any = { 'Afghanistan': "AF", "Aland Islands": "AX",'Albania': "AL",'Algeria': "DZ",'American Samoa': "AS",'Andorra': "AD",'Angola': "AO",
...
//       };
  ...
  getCityData(country){
    this.countryURI = this.api_base_uri.concat(country.toLowerCase());
    return this.http.get(this.countryURI);
  }
